...
function ProductList({ onHomeClick }) {
    ...
    return (
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '1100px' }}>
          <div>
            <a href="#" style={{ color: 'white', fontSize: '30px', textDecoration: 'none' }}>Plants</a>
          </div>
          <div>
            <a href="#" onClick={handleCartClick} style={{ color: 'white', fontSize: '30px', textDecoration: 'none' }}>
              <h1 className="cart">
                ...
                <span style={{ position: 'relative', top: '-40px', left: '-20px', fontSize: '20px', fontWeight: 'bold' }}>{totalCartItems}</span>
              </h1>
            </a>
          </div>
        </div>
